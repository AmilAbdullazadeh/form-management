...
import { FieldFormValues, FieldModalProps } from '@/features/FormManagement/api/models/FormManagementModel';
import { DEFAULT_FIELD_VALUES } from '@/resources/constants/form';
import { validateFieldName } from '@/shared/utils/validation';


export const useField = ({ isOpen, onSave, onClose, existingFields = [], fieldToEdit }: FieldModalProps) => {
